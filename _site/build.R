local({
  ...
  jekyll.encoding = servr:::jekyll_config('.', 'encoding', 'UTF-8')
  ...
  knitr::knit(a[1], a[2], quiet = TRUE, encoding = jekyll.encoding, envir = .GlobalEnv)

  #Convert ouput to UTF-8
  #cmd <- paste0("iconv -f ", jekyll.encoding, " -t UTF8 ", a[2], ">/tmp/kk")
  #print(cmd)
  #system(cmd)
  #print(cmd)
  #cmd <- paste0("mv /tmp/kk ", a[2])
  #system(cmd)
})
